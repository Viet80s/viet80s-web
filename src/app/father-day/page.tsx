    ...
    <>
      <div className="bg-black">
        ...
        <div className="flex px-6 md:px-20 pt-10 gap-6 items-center justify-center overflow-hidden">
          <div className="flex flex-col sm:px-10 px-10 gap-6 justify-between md:flex-row items-center max-w-8xl">
            <div className="w-full md:w-1/2">
              <h2 className="text-3xl lg:text-4xl text-center md:text-center text-primary leading-tight font-medium px-7">
                Celebrate Father&apos;s Day 2024 at <br />
                Viet80s Restaurant
              </h2>
              <h3 className="mt-6 md:mt-10 text-md lg:text-lg text-center md:text-center text-primary font-light tracking-wider leading-relaxed px-7">
