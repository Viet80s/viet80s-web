...
>(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn(
      "flex flex-wrap items-center gap-1.5 break-words text-sm text-muted-foreground sm:gap-2.5 text-primary",
      className
    )}
    {...props}
  />
...
>(({ asChild, className, ...props }, ref) => {
  ...
  return (
    <Comp
      ref={ref}
      className={cn(
        "transition-colors hover:text-primary hover:opacity-85 text-primary",
        className
      )}
      {...props}
    />
